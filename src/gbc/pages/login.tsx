...
const Login: FunctionComponent = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
      ...
      if(isFormValid) {
        ...
        AuthenticationService.login(form.userName.value, form.motPasse.value).then(isAuthenticated => {
    ...
    return (
        <Container>
          <Row className='mt-4'>
            <h1 className="shadow-sm text-success mt-4 p-3 text-center rounded">CONNEXION GBC</h1>
