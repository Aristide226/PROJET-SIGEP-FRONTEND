...
import ReediterLePpmForm from '../components/contrats-plan-de-passation-reediter-le-ppm-form';

interface IAppProps {
}

const ContratsPlanDePassationReediterLePpm: FunctionComponent<IAppProps> = (props) => {
  return (
      <div>
...
export default ContratsPlanDePassationReediterLePpm;
