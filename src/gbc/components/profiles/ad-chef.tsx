...
const AdChef: FunctionComponent<IAppProps> = (props) => {
       ...
       <Navbar.Collapse id="basic-navbar-nav">
         <Nav>
           ...
           <NavDropdown title="Budget" id="budget" menuVariant="dark" className='navbar-link'>
             ...
             <NavDropdown.Item href="/gbc/budget-annuler-un-projet-de-reamenagement" className='navbar-link'>Annuler un projet de réamenagement</NavDropdown.Item>
           </NavDropdown>
