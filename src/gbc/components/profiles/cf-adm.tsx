       ...
       <Navbar.Collapse id="basic-navbar-nav">
         <Nav>
           ...
           <NavDropdown title="Budget" id="budget" menuVariant="dark" className='navbar-link'>
             <NavDropdown.Item href="/gbc/budget-valider-la-modification-du-budget" className='navbar-link'>Valider la modification du budget { props.gestionCourante }</NavDropdown.Item>
             ...
             <NavDropdown.Divider />
             <NavDropdown.Item href="/gbc/budget-valider-un-projet-de-reamenagement" className='navbar-link'>Valider un projet de réaménagement</NavDropdown.Item>
           ...
           <NavDropdown title="Contrats" id="contrats" menuVariant="dark" className='navbar-link'>
             <NavDropdown title="Plan de passation" id="plan-de-passation" menuVariant="dark" drop='end' className='navbar-link'>
              <NavDropdown.Item href="/gbc/contrats-plan-de-passation-valider-une-modification" className='navbar-link'>Valider une modification</NavDropdown.Item>
              <NavDropdown.Divider />
           ...
           <NavDropdown title="Engagements" id="engagements" menuVariant="dark" className='navbar-link'>
             <NavDropdown.Item href="/gbc/engagements-valider-rejeter-projet-d-engagement" className='navbar-link'>Valider / Rejeter projet d'engagement</NavDropdown.Item>
             <NavDropdown title="Transmettre projet d'engagement" id="transmettre-projet-d-engagement" menuVariant="dark" drop='end' className='navbar-link'>
               <NavDropdown.Item href="/gbc/engagements-transmettre-projet-d-engagement-valide-a-l-adm-de-credits" className='navbar-link'>Validé à l'Adm. de Crédits</NavDropdown.Item>
               <NavDropdown.Item href="/gbc/engagements-transmettre-projet-d-engagement-rejete-a-l-adm-de-credits" className='navbar-link'>Réjeté à l'Adm de Crédits</NavDropdown.Item>
             </NavDropdown>
           </NavDropdown>

           <NavDropdown title="Liquidation" id="liquidation" menuVariant="dark" className='navbar-link'>
             <NavDropdown.Item href="#" className='navbar-link'>Valider / Rejeter une liquidation</NavDropdown.Item>
             <NavDropdown title="Transmettre une liquidation" id="transmettre-une-liquidation" menuVariant="dark" drop='end' className='navbar-link'>
           ...
           <NavDropdown title="Titre recette" id="titre-recette" menuVariant="dark" className='navbar-link'>
             <NavDropdown.Item href="#" className='navbar-link'>Validation / Rejet</NavDropdown.Item>
           ...
           <NavDropdown title="Pénalités de retard" id="penalites-de-retard" menuVariant="dark" className='navbar-link'>
             ...
             <NavDropdown.Divider />
             <NavDropdown.Item href="#" className='navbar-link'>Annulation</NavDropdown.Item>
           </NavDropdown>
