...
const EngagementsTransmettreProjetDEngagementForm: FunctionComponent = () => {
  ...
  const getEngagements = () => {
    EngagementViewService.getEngagementValideEtNonTransmis(Number(gestionCourante), Number(idBudget)).then(data => {
      setEngagements(data) 
  ...
  const handleEditerBordereauEngagementButtonClick = () => {
    ...
    bordTransmisRequestDto.dossier = "E1";
  ...
  return (
    <Container>
          <div className="mt-1 p-1">
            <h6 className="shadow-sm text-primary text-center rounded">ENGAGEMENTS &gt; EDITION DE BORDEREAU DE TRANSMISSION DE PROJETS D'ENGAGEMENT VALIDES</h6>
            <Form>
              <Card className="mb-1">
...
export default EngagementsTransmettreProjetDEngagementForm;
