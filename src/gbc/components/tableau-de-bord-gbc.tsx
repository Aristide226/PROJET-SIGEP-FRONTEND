...
const TableauDeBordGbc: React.FunctionComponent<IAppProps> = (props) => {
  return(
      <Container>
          <Row className="mt-1 p-1">
            <h6 className='shadow-sm rounded text-center text-primary'><b>TABLEAU DE BORD { Gestion() }</b></h6>
...
export default TableauDeBordGbc;
