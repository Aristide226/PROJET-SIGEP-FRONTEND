...
const LiquidationReediterBordereauDeLiquidationForm: FunctionComponent = () => {
  ...
  const getLiquidations = () => {
    LiquidationViewService.getByGestionAndIdBudgetOrderByNumBeDesc(Number(gestionCourante), Number(idBudget)).then(data => {
  ...
  return (
    <Container>
          <div className="mt-1 p-1">
            <h6 className="shadow-sm text-primary text-center rounded">LIQUIDATION &gt; REEDITER BORDEREAU DE LIQUIDATION</h6>
            <Form>
              <Card className="mb-1">
...
export default LiquidationReediterBordereauDeLiquidationForm;
