...
const RhInv : FunctionComponent<IAppProps> =()=> {
    return (
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav>
                        ...
                        <NavDropdown title="Paramètrage" id="parametrage" menuVariant="dark" className="navbar-link">
                            ...
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Mettre à jour le régime et barèmes</NavDropdown.Item>
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Mettre à jour les éléments de salaire</NavDropdown.Item>
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Mettre à jour Visas, Ampliataires et article acte</NavDropdown.Item>
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Mettre à jour les informations de la structure</NavDropdown.Item>
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Mettre à jour la liste direction et services</NavDropdown.Item>
                        ...
                        <NavDropdown title="Traitement administratif" id="traitement-administratif" menuVariant="dark" className="navbar-link">
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Maj liste d'agent</NavDropdown.Item>
                            <NavDropdown title="Acte d'entrée" id="acte-dentree" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer / Mettre à jour l'acte d'engagement</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer un acte d'engagement</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'disabled>Annuler un acte d'engagement</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Acte modifiant classif." id="acte-modifiant-classif" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir / Mettre à jour note</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer / Mettre à jour d'acte</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer un acte</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Annuler saisie d'acte</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir / Mettre à jour acte manuel d'avancement</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Affectation" id="affectation" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer / Mettre à jour la décision</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer une décision</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Annuler une décision</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir / Mettre à jour acte manuel</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Prise de service" id="prise-de-service" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer / Mettre à jour le certificat de prise de service</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer le certificat de prise de service</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Annuler le certificat de prise de service</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir / Mettre à jour acte manuel de prise de service</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Nomination" id="nomination" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer / Mettre à jour l'acte</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer acte</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Annuler acte</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir / Mettre à acte manuel</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Congés" id="conges" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer / Mettre à jour acte de congé</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer acte de congé généré</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Annuler acte de congé généré</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir / Mettre à jour acte manuel de congé</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Fin d'engagement" id="fin-dengagement" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer/Mettre à jour acte</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer acte de fin</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Annuler acte de fin</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir / Mettre à jour acte de fin manuel</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title="Cessation de service" id="cessation-de-service" menuVariant="dark" drop='end' className="navbar-link">
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Générer/Mettre à jour acte de cessation</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link'>Rééditer acte de cessation</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Annuler acte de cessation</NavDropdown.Item>
                                <NavDropdown.Item href="#" className='navbar-link' disabled>Saisir/Mettre à jour acte de cessation manuel</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Situation matrimoniale</NavDropdown.Item>
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Valider acte</NavDropdown.Item>
                            <NavDropdown.Item href="#" className='navbar-link' disabled><b>Marquer un acte signé</b></NavDropdown.Item>
                        </NavDropdown>
                        ...
                        <NavDropdown title="Transmission" id="transmission" menuVariant="dark" className="navbar-link">
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Actes administratif</NavDropdown.Item>
                            <NavDropdown.Item href="#" className='navbar-link' disabled>Traitement solde mensuelle</NavDropdown.Item>
                        </NavDropdown>
